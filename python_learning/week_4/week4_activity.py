...
# #indexing is a way to get a subrstring from a string
...
# print(result.find('cheerleaders')) #prints -1 because cheerleaders doesnt exist
...
sentence =  "Especially in electronic communications, writing in all caps is equivilant to yelling."
...
print(sentence.find("communications")) #prints the index of the word communication
#uppercase the word "communications" in the sentence
print(sentence.replace("communcations" , " COMMUNICATIONS")) #print the index of thr word communication
#uppercase the word "communications" in the sentence
# use the slicing method

print(sentence[26:39].upper()) #prints the word communication to uppercase
print(sentence.replace("communications" , "COMMUNICATIONS")) 

print(sentence.replace("communications" , "communications".upper()))
#prints the sentence word in uppercase
new_sentence = "if the implementation is hard to explain, it might be a bad idea."
#replace the word hard with easy and bad to good
...
#this method by default, splits the sentence by commas
print(sentence4.split("a"))  #splits the sentence into a list of words using separator
#this prints out as ["I am a python programmer"]

#concentration words in python repititon 15 times
result = "repetition" * 1
print(result)
